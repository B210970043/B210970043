...
<section class="vh-50" style="background-color: #2779e2;">
  <div class="container h-100">
    <form action='store_data' method="POST">
        ...
        <div class="col-xl-9">
            <h1><x-form.label value="Хэрэглэгчийн дэлгэрэнгүй мэдээлэл" /></h1>
            <div class="card" style="border-radius: 15px;">
            <div class="card-body">
                <div class="row align-items-center pt-4 pb-3">
                    <div class="col-md-3 ps-5">
                        <label for="user_first_name" class="form-label">Хэрэглэгчийн нэр:</label>
                        <input type="text" id="user_first_name" name="user_first_name" class="form-control" required value="{{ Auth::user()->name }}">
                    </div>
                ...
                <div class="px-5 py-4">
                    <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg">Хадгалах</button>
                    <a href="/profile" class="btn btn-secondary btn-lg">Буцах</a>
                </div>
